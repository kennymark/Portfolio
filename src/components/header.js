    ...
    <>
      <nav className="flex items-center justify-between flex-wrap bg-white-500 p-6 border">
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
          <div className="text-md lg:flex-grow hidden lg:flex sm:abosulute"  >
            {pages.map((page, key) =>
        ...
        <div className="hidden sm:flex">
          {/* <button className="btn shadow-sm bg-yellow-500 p-1 text-black focus:outline-none hover:shadow-xl  mr-2">View CV</button> */}
