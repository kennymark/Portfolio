...
const components = {
  ...
  pre: props => <Box rounded='lg' {...props} />,
  code: props => <CodeBlock {...props} />,
  img: props => <Box as={Img} rounded='lg' mx='auto' maxH={500} border='1px' borderColor='gray.200' shadow='lg' {...props} />,
  inlineCode: props => <Box as='span' fontSize={18} rounded='md' w='auto' px={2} color='gray.400' bg='#011627' fontFamily='work sans' {...props} />,
